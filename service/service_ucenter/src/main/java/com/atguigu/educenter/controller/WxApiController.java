...
public class WxApiController {
    ...
    public String getWxCode() {
        //请求一个固定地址，后面拼接参数
        // 微信开放平台授权baseUrl    其中%s相当于?代表占位符，后面填充
        ...
        String redirectUrl = ConstantWxUtils.WX_OPEN_REDIRECT_URL;      //微信url编码
        try {
            redirectUrl = URLEncoder.encode(redirectUrl, "utf-8");
        }catch(Exception e) {
        }

        //设置%s里面值   appid=ConstantWxUtils.WX_OPEN_APP_ID 微信id
    ...
    public String callback(String code, String state) {
        try {
            ...
            //accsess_token:访问凭证   open_id：每个微信唯一标识
